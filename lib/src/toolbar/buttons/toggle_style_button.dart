...
Widget defaultToggleStyleButtonBuilder(
  ...
  return QuillToolbarIconButton(
    icon: attribute.key.toString() == 'small'
        ? Image.asset(
            // AppAsset.ttImage,
            'assets/images/png/create/tt.png',
            height: 25,
            color: isToggled == true ? Colors.white : null,
          )
        : attribute.key.toString() == 'bold'
            ? Image.asset(
                // AppAsset.bImage,
                'assets/images/png/create/b.png',
                height: 25,
                color: isToggled == true ? Colors.white : null,
              )
            : attribute.key.toString() == 'italic'
                ? Image.asset(
                    // AppAsset.iImage,
                    'assets/images/png/create/i.png',
                    height: 25,
                    color: isToggled == true ? Colors.white : null,
                  )
                : attribute.key.toString() == 'underline'
                    ? Image.asset(
                        // AppAsset.uImage,
                        'assets/images/png/create/u.png',
                        height: 25,
                        color: isToggled == true ? Colors.white : null,
                      )
                    : Icon(
